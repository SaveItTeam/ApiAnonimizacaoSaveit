...
class Admin(Resource):
    ...
    def post(self):
        ...
        df_admin_anonimizado['nome_empresa'] = df_admin_anonimizado['nome_empresa'].map(Anonimizacao.mascarar)
        df_admin_anonimizado['nome_admin'] = df_admin_anonimizado['nome_admin'].map(Anonimizacao.mascarar)
